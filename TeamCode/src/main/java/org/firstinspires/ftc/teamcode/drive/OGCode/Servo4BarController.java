...
public class Servo4BarController {
    ...
    public static double Ground_Position=0.92, Second_Cone_Position=0.9, Third_Cone_Position=0.86, Fourth_Cone_Position = 0.82, Fifth_Cone_Position = 0.775,
    ...
    public static double Ground_Position_South=0.92, Second_Cone_Position_South=0.885, Third_Cone_Position_South=0.845, Fourth_Cone_Position_South = 0.8, Fifth_Cone_Position_South = 0.755;

    public static double CyclingSouthPositions[] = {0,0.92,0.885,0.845,0.8,0.755};
